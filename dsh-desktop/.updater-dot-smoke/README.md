...
Build the portable folder first, then create an NSIS installer:
...
The installer is written to `release-installer\DSH Desktop-Setup-<version>.exe`. It offers a per-user installation by default, desktop and Start menu shortcuts, and uninstallation. This local command intentionally has no update feed.
